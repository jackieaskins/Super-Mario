...
public class GreenKoopaTroop extends Enemy {
    ...
    private static String[] img_files_rt = {"Green_Koopa_TroopaR.gif", "Green_Koopa_TroopaR.gif",
            "Green_Koopa_Troopa2R.gif", "Green_Koopa_Troopa2R.gif"};
    private static String[] img_files_lt = {"Green_Koopa_Troopa.gif", "Green_Koopa_Troopa.gif",
            "Green_Koopa_Troopa2.gif", "Green_Koopa_Troopa2.gif"};
